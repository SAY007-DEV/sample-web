...
class PHPMailer
{
     ...
     * Useful if the SMTP class is not in the PHP include_once path.
     * @type string
     ...
     * require_onces an explicit call to smtpClose().
     * @type boolean
     */
     ...
     * include_onces all of $to, $cc, $bcc, $replyto
     * @type array
     * @access protected
     */
     ...
     * * `pcre8` Use the squiloople.com pattern, require_onces PCRE > 8.0, PHP >= 5.3.2, 5.2.14;
    ...
    public static function validateAddress($address, $patternselect = 'auto')
    {
        if (!$patternselect or $patternselect == 'auto') {
            if (defined('PCRE_VERSION')) { //Check this constant so it works when extension_loaded() is disabled
                ...
                //Filter_var appeared in PHP 5.2.0 and does not require_once the PCRE extension
