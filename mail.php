...
$mail->addAddress('hnhphysio@gmail.com', 'Healthy Happy '); 

$mail->Subject = 'Contact Enquiry - Healthy Happy';
                ...
                <table cellspacing="0" cellpadding="10" border="" class="m_-1454359957100666214table_full_width" style="outline:none;border-collapse:collapse;border-spacing:0;table-layout:fixed;width:100%;margin:0;padding:0;border: solid 1px #d4d4d4;font-family: Montserrat, sans-serif;">
                  ...
                  <tbody>
                     <tr style="width: 100%;">
                      ...
                      <td style="width: 50%;">
                        <span style="width: 100%;float:left;line-height: 25px;color: #454545;font-weight: 500;font-size: 13px;">'.$firstname.' '.$lastname.'</span>
                      </td>
                    </tr>
                   
                      <tr style="width: 100%;">
                      <td style="width: 50%;">
                        <span style="width: 100%;float:left;line-height: 25px;color: #454545;font-weight: 600;font-size: 13px;">Mobile Number  </span>
                      </td>
                      <td style="width: 50%;">
                        <span style="width: 100%;float:left;line-height: 25px;color: #454545;font-weight: 500;font-size: 13px;">'.$phone.'</span>
                      </td>
                    </tr>
                    ...
                    <tr style="width: 100%;">
                      <td style="width: 50%;">
                        <span style="width: 100%;float:left;line-height: 25px;color: #454545;font-weight: 600;font-size: 13px;">Meassage </span>
                      </td>
                      <td style="width: 50%;">
                  ...
                  <tbody>
                    <tr>
                      <td class="m_-1454359957100666214add_our_email_td" style="outline:none;width:100%;margin:0;padding:25px 0;" align="center" valign="top">
                        <p style="outline:none;margin:0;padding:0;color:#fcbd12;font-family:Montserrat, sans-serif;font-size:16px;font-style:normal;font-weight:800;line-height:24px;word-spacing:0;text-transform: uppercase;letter-spacing: 0.8px;"> <span style="color: #000;">Healthy Happy</span></p>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
if(!$mail->send()) {
   ...
   header("location:contact.php?success=Enquiry has been submited successfully!" );
